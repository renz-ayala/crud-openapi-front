...
export class PlacaControllerService extends BaseService {
    ...
    /**
     * @endpoint post /placas/obtener-reporte
     * @param placaRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param options additional options
     */
    public getReporte(placaRequest: PlacaRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/pdf', context?: HttpContext, transferCache?: boolean}): Observable<string>;
    public getReporte(placaRequest: PlacaRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/pdf', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<string>>;
    public getReporte(placaRequest: PlacaRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/pdf', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<string>>;
    public getReporte(placaRequest: PlacaRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/pdf', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (placaRequest === null || placaRequest === undefined) {
            throw new Error('Required parameter placaRequest was null or undefined when calling getReporte.');
        }
        ...
        let localVarPath = `/placas/obtener-reporte`;
